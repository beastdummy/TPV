...
export const SALES_TX_ERROR_CODES = {
	POS_OPERATOR_REQUIRED: "POS_OPERATOR_REQUIRED",
	POS_OPERATOR_INVALID: "POS_OPERATOR_INVALID",
	POS_PIN_INVALID: "POS_PIN_INVALID",
	POS_PIN_AMBIGUOUS: "POS_PIN_AMBIGUOUS",
